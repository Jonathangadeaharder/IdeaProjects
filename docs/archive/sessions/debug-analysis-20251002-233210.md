...
### Priority 1: Transaction-Related Failures (18 tests) 🔴
...
### Priority 2: Vocabulary Service Failures (10 tests) 🔴
...
### Priority 3: New Security Test Failures (26 tests) 🟡
...
### Priority 4: Auth Service Migration Fallout (4 tests) 🟡
...
3. Update hash format expectations (bcrypt → Argon2)
