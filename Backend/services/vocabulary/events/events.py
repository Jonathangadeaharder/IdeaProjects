"""
Domain events for vocabulary operations.
Events represent things that have happened in the vocabulary domain.

Moved from domains/vocabulary/events.py to eliminate unused DDD layer.
"""
...
class LevelCompletedEvent(DomainEvent):
    ...
    difficulty_level: "CEFRLevel | None" = None
