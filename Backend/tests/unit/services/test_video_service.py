...
class MockPath:
    ...
    def __init__(self, path_str: str, exists: bool = True, is_dir: bool = True,
                 is_file: bool = False, suffix: str = "", stem: str = "", name: str = ""):
...
def mock_videos_root():
    ...
    direct_video = MockPath("direct_video.mp4", exists=True, is_dir=False, is_file=True,
                           suffix=".mp4", stem="direct_video", name="direct_video.mp4")
    ...
    episode1 = MockPath("Episode 1 Pilot.mp4", exists=True, is_dir=False, is_file=True,
                       suffix=".mp4", stem="Episode 1 Pilot", name="Episode 1 Pilot.mp4")
    episode2 = MockPath("Episode 2 The Beginning.mp4", exists=True, is_dir=False, is_file=True,
                       suffix=".mp4", stem="Episode 2 The Beginning", name="Episode 2 The Beginning.mp4")
...
class TestVideoService(ServiceTestBase):
    ...
    def test_get_available_videos_with_subtitles(self, mock_settings, video_service):
        ...
        video_with_subs = MockPath("video_with_subs.mp4", exists=True, is_file=True,
                                  suffix=".mp4", stem="video_with_subs", name="video_with_subs.mp4")
    ...
    def test_get_available_videos_video_info_creation(self, mock_settings, video_service):
        ...
        # Setup
        root = MockPath("/videos", exists=True, is_dir=True)
        video = MockPath("test episode 5.mp4", exists=True, is_file=True,
                        suffix=".mp4", stem="test episode 5", name="test episode 5.mp4")
...
class TestVideoServiceAdvancedScenarios(ServiceTestBase):
    ...
    def test_get_available_videos_complex_directory_structure(self, mock_settings, video_service):
        ...
        # Add direct videos
        direct_video1 = MockPath("Movie.mp4", exists=True, is_file=True,
                                suffix=".mp4", stem="Movie", name="Movie.mp4")
        direct_video2 = MockPath("Documentary Episode 1.mp4", exists=True, is_file=True,
                                suffix=".mp4", stem="Documentary Episode 1", name="Documentary Episode 1.mp4")
        ...
        series1_ep1 = MockPath("S01E01 Pilot.mp4", exists=True, is_file=True,
                              suffix=".mp4", stem="S01E01 Pilot", name="S01E01 Pilot.mp4")
        series1_ep2 = MockPath("S01E02 The Chase.mp4", exists=True, is_file=True,
                              suffix=".mp4", stem="S01E02 The Chase", name="S01E02 The Chase.mp4")
        ...
        series2_ep1 = MockPath("Episode_01_Beginning.mp4", exists=True, is_file=True,
                              suffix=".mp4", stem="Episode_01_Beginning", name="Episode_01_Beginning.mp4")
    ...
    def test_get_available_videos_unicode_filenames(self, mock_settings, video_service):
        ...
        unicode_video1 = MockPath("Café_Episode_1.mp4", exists=True, is_file=True,
                                 suffix=".mp4", stem="Café_Episode_1",
                                 name="Café_Episode_1.mp4")
        unicode_video2 = MockPath("ドラマ_Episode_2.mp4", exists=True, is_file=True,
                                 suffix=".mp4", stem="ドラマ_Episode_2", name="ドラマ_Episode_2.mp4")

        unicode_series = MockPath("Película_Española", exists=True, is_dir=True,
                                 name="Película_Española")
        unicode_episode = MockPath("Episodio_1_¡Hola!.mp4", exists=True, is_file=True,
                                  suffix=".mp4", stem="Episodio_1_¡Hola!",
    ...
    def test_get_available_videos_mixed_file_types(self, mock_settings, video_service):
        ...
        # Valid video files
        valid_video1 = MockPath("valid1.mp4", exists=True, is_file=True,
                               suffix=".mp4", stem="valid1", name="valid1.mp4")
        valid_video2 = MockPath("valid2.MP4", exists=True, is_file=True,
                               suffix=".MP4", stem="valid2", name="valid2.MP4")

        # Invalid files (should be ignored)
        invalid_video1 = MockPath("invalid.avi", exists=True, is_file=True,
                                 suffix=".avi", stem="invalid", name="invalid.avi")
        invalid_video2 = MockPath("invalid.mkv", exists=True, is_file=True,
                                 suffix=".mkv", stem="invalid", name="invalid.mkv")
        text_file = MockPath("readme.txt", exists=True, is_file=True,
                            suffix=".txt", stem="readme", name="readme.txt")
    ...
    def test_get_available_videos_empty_series_directories(self, mock_settings, video_service):
        ...
        valid_episode = MockPath("Episode1.mp4", exists=True, is_file=True,
                                suffix=".mp4", stem="Episode1", name="Episode1.mp4")
    ...
    def test_get_available_videos_very_long_filenames(self, mock_settings, video_service):
        ...
        long_video = MockPath(long_filename, exists=True, is_file=True,
                             suffix=".mp4", stem=long_name, name=long_filename)
    ...
    def test_get_available_videos_special_characters_in_paths(self, mock_settings, video_service):
        ...
        special_video1 = MockPath("Video [2024] Episode 1.mp4", exists=True, is_file=True,
                                 suffix=".mp4", stem="Video [2024] Episode 1",
                                 name="Video [2024] Episode 1.mp4")
        special_video2 = MockPath("Show (HD) - Episode 2.mp4", exists=True, is_file=True,
                                 suffix=".mp4", stem="Show (HD) - Episode 2",
                                 name="Show (HD) - Episode 2.mp4")
        special_video3 = MockPath("Series & More Episode 3.mp4", exists=True, is_file=True,
                                 suffix=".mp4", stem="Series & More Episode 3",
    ...
    def test_get_available_videos_concurrent_file_changes(self, mock_settings, video_service):
        ...
        disappearing_video = MockPath("temp.mp4", exists=True, is_file=True,
                                     suffix=".mp4", stem="temp", name="temp.mp4")
    ...
    def test_get_available_videos_case_sensitive_extensions(self, mock_settings, video_service):
        ...
        def mock_glob(pattern):
            if pattern == "*.mp4":
                return [
                    MockPath("video1.mp4", exists=True, is_file=True,
                            suffix=".mp4", stem="video1", name="video1.mp4"),
                    MockPath("video2.MP4", exists=True, is_file=True,
                            suffix=".MP4", stem="video2", name="video2.MP4"),
                    MockPath("video3.Mp4", exists=True, is_file=True,
                            suffix=".Mp4", stem="video3", name="video3.Mp4")
                ]
            return []
...
class TestVideoServiceEpisodeParsing(ServiceTestBase):
    ...
    def test_parse_episode_filename_international_formats(self, video_service):
        ...
        test_cases = [
            ...
            ("Saison 4 Episode 3 L'Aventure", {"title": "Saison 4 Episode 3 L'Aventure", "season": None, "episode": "3"}),

            # Spanish formats (service doesn't recognize these keywords)
            ("Temporada 2 Episodio 7 El Final", {"title": "Temporada 2 Episodio 7 El Final", "season": None, "episode": None}),
        ]
...
class TestVideoServiceExceptionCoverage(ServiceTestBase):
    ...
    def test_get_available_videos_direct_video_processing_exception(self, mock_settings, video_service):
        ...
        problem_video = MockPath("corrupted.mp4", exists=True, is_file=True,
                                suffix=".mp4", stem="corrupted", name="corrupted.mp4")
    ...
    def test_get_available_videos_series_video_processing_exception(self, mock_settings, video_service):
        ...
        series_dir = MockPath("TestSeries", exists=True, is_dir=True, name="TestSeries")
        problem_video = MockPath("Episode 1.mp4", exists=True, is_file=True,
                                suffix=".mp4", stem="Episode 1", name="Episode 1.mp4")
