...
class BackendTestRunner:
    ...
    def run_all_tests(self, suites: Optional[List[str]] = None, coverage: bool = False) -> bool:
    ...
    def run_test_suite(self, suite: TestSuite, coverage: bool = False) -> bool:
        ...
        if not suite_path.exists():
            ...
            self.results.append(TestResult(
                ...
                status="skipped",
                duration=0.0,
                details=f"Path not found: {suite_path}"
            ))
    ...
    def generate_junit_report(self) -> None:
        ...
        try:
            ...
            print(f"[INFO] JUnit report written to test-results-backend.xml")
    ...
    def generate_json_report(self) -> None:
        ...
        try:
            ...
            print(f"[INFO] JSON report written to test-results-backend.json")
