...
describe('VocabularyGame Component', () => {
  ...
  describe('Basic Functionality', () => {
    ...
    it('calls onWordAnswered when know button clicked', async () => {
      render(
        <VocabularyGame
          ...
          onWordAnswered={mockOnWordAnswered}
        />
      )
    ...
    it('shows no words message when empty words provided', () => {
      ...
      expect(
        screen.getByText('You already know all the vocabulary in this segment. Great job!')
      ).toBeInTheDocument()
    })
  })
      ...
      const longTranslationWord = [
        {
          ...
          word: 'Schadenfreude',
          translation:
            'The feeling of pleasure or satisfaction that comes from witnessing the misfortune of others',
  ...
  describe('User Interaction', () => {
    ...
    it('WhenCardClicked_ThenShowsTranslation', async () => {
      ...
      const wordCard =
        screen.getByText('Hallo').closest('[role="button"]') ||
  ...
  describe('Visual States', () => {
    it('WhenGameLoading_ThenShowsLoadingState', () => {
      ...
      const _loadingIndicator =
        screen.queryByTestId('loading-spinner') || screen.queryByText(/loading/i)
    ...
    it('WhenIncorrectAnswer_ThenShowsEncouragingFeedback', async () => {
      ...
      const unknownButton =
        buttons.find(button => getComputedStyle(button).color.includes('239, 68, 68')) || buttons[0]
  ...
  describe('Performance', () => {
    ...
    it('WhenRapidProgression_ThenMaintainsPerformance', async () => {
      ...
      await act(async () => {
        ...
        const updatedKnowButton =
          updatedButtons.find(button => getComputedStyle(button).color.includes('70, 211, 105')) ||
