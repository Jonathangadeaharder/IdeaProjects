...
Replaces slow Argon2/bcrypt operations with instant mocks.
Works with fastapi-users 14.0.1 + pwdlib.
"""
...
# Pre-hashed password for testing (mock hash of "TestPassword123!")
FAST_PASSWORD_HASH = "$fast_hash$123456$" + str(hash("TestPassword123!" + "123456"))
...
class FastCryptContext:
    ...
    def verify(self, password: str, hash_value: str) -> bool:
        """Verify password against mock hash"""
...
def fast_passwords():
    ...
    def fast_verify(password: str, hashed: str) -> bool:
        """Fast verification for our mock hashes"""
