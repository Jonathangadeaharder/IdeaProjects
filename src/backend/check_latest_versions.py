...
PACKAGES = [
    # Core Web Framework
    "fastapi", "pydantic", "pydantic-settings", "python-multipart", "uvicorn",
    # Authentication & Security
    "fastapi-users", "argon2-cffi", "python-jose", "passlib",
    # Database
    "sqlalchemy", "aiosqlite", "alembic",
    # AI/ML Core
    "openai-whisper", "transformers", "torch", "spacy", "sentencepiece", "protobuf",
    # Audio/Video
    ...
    # Utilities
    "psutil", "websockets", "pyyaml", "rich", "tqdm", "pandas", "numpy",
    # Testing
    "pytest", "pytest-asyncio", "pytest-cov", "pytest-xdist", "pytest-timeout",
    "hypothesis", "pytest-env", "httpx", "respx", "anyio", "trio", "freezegun", "responses",
    # Code Quality
    "pre-commit", "ruff", "mypy", "bandit", "detect-secrets", "radon", "wily", "lizard",
    # Type Stubs
